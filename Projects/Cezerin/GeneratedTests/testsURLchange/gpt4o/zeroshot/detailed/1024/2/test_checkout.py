...
class TestAddToCartProcess(unittest.TestCase):
    ...
    def test_checkout_process(self):
        ...
        category_a = self.wait.until(presence_of_element_located((By.XPATH, "//a[@href='/category-a']")))
        category_a.click()

        # Step 2: Select the first product
        product_a = self.wait.until(presence_of_element_located((By.XPATH, "//a[@href='/category-a/product-a']")))
        product_a.click()
        ...
        go_to_checkout_button = self.wait.until(presence_of_element_located((By.XPATH, "//a[contains(text(), 'GO TO CHECKOUT')]")))
        ...
        email_field = self.wait.until(presence_of_element_located((By.ID, "customer.email")))
