...
class TestCategoryAFiltering(unittest.TestCase):
    ...
    def test_filter_brand_a(self):
        ...
        brand_a_checkbox = WebDriverWait(self.driver, 20).until(EC.presence_of_element_located((By.XPATH, "//input[@name='brand']"))))
    ...
    def test_filter_price_range(self):
        ...
        price_slider = WebDriverWait(self.driver, 20).until(EC.presence_of_element_located((By.XPATH, "//input[@class='price-slider']")))
