...
def find_category_button(self, category_name):
    ...
    category_button = WebDriverWait(self.driver, 20).until(
        EC.element_to_be_clickable((By.XPATH, "//button[contains(text(), 'Category') and contains(text(), '{}'))]".format(category_name)))
...
def find_product_button(self, product_name):
    ...
    product_button = WebDriverWait(self.driver, 20).until(
        EC.element_to_be_clickable((By.XPATH, "//button[contains(text(), 'Product') and contains(text(), '{}'))]".format(product_name)))
