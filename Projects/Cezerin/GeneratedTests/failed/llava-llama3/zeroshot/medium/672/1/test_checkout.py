...
next_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH,
...
place_order_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH,
...
html_data.load_html("html_data/checkout_test.html")
order_receipt_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH,
...
url = "http://localhost:3000/checkout"
html_data.load_html("html_data/checkout_test.html")
order_completion_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH,
...
url = "http://localhost:3000/checkout"
html_data.load_html("html_data/checkout_test.html")
order_confirmation_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH,
...
url = "http://localhost:3000/checkout"
html_data.load_html("html_data/checkout_test.html")
order_completion_and_order_confirmation_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH,
