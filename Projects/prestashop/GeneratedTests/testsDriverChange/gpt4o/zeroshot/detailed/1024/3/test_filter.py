...
class ProductFilterTest(unittest.TestCase):
    ...
    def test_product_filter(self):
        ...
        filter_checkbox = wait.until(EC.presence_of_element_located((By.XPATH, filter_section_selector)))
        ...
        clear_filter_button = wait.until(EC.presence_of_element_located((By.XPATH, clear_filter_selector)))
