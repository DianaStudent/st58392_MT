...
class TestAddProductToCart(unittest.TestCase):
    ...
    def test_add_product_to_cart(self):
        ...
        add_to_cart_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//button[contains(text(), 'Add to cart')]")))
        ...
        proceed_to_checkout_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//button[contains(text(), 'Proceed to checkout')]")))
