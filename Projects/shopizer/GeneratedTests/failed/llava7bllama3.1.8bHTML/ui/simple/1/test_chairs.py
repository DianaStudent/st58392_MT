...
class TestShopUI(unittest.TestCase):
    ...
    def test_tables_page(self):
        ...
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.LINK_TEXT, "Chairs")))
    ...
    def test_chairs_page(self):
        ...
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.LINK_TEXT, "Tables")))
