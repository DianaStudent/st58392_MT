...
class TestFiltering(unittest.TestCase):
    ...
    def test_filtering(self):
        # Apply "Tables" filter
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//a[@class='filter-item filter-tables']"))).click()
        ...
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//a[@class='filter-item filter-chairs']"))).click()
        ...
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//a[@class='filter-item filter-all']"))).click()
