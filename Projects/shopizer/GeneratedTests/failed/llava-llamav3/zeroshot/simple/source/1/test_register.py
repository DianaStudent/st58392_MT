...
try:
# Fill the name field
name_input = self.wait.until(EC.element_to_be_clickable((By.XPATH, "//input[@id='userName']")))
name_input.send_keys("Test User")
# Fill the email field with a dynamically generated email
email_input = self.wait.until(EC.element_to_be_clickable((By.XPATH, "//input[@id='userEmail']")))
email_input.send_keys(self.generate_email())
# Fill the password and repeat password fields with the same value
password_input = self.wait.until(EC.element_to_be_clickable((By.XPATH, "//input[@id='userPassword']")))
repeat_password_input = self.wait.until(EC.element_to_be_clickable((By.XPATH, "//input[@id='repeatPassword']")))
