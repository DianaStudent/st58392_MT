...
email_field = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.ID, "user_email")))
password_field = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.ID, "user_password")))
...
billing_name_field = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.ID, "order_note")))
billing_address_field = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.ID, "shipping_address_1")))
city_field = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.ID, "user_city")))
state_field = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.ID, "user_state")))
zip_code_field = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.ID, "user_zipcode")))
