...
class UserRegistrationTest(unittest.TestCase):
    ...
    def test_user_registration(self):
        ...
        try:
            ...
            self.fail("Account icon/button not interactable")
        ...
        try:
            ...
            # Click somewhere outside to avoid overlay issues
            driver.find_element(By.XPATH, "//h4[contains(text(),'Register')]").click()
            ...
            self.fail("Error filling registration form or interacting with elements")

        # Confirm registration success
        if not wait.until(EC.url_contains("/my-account")):
