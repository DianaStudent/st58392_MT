...
class RegistrationTest(unittest.TestCase):
    ...
    def test_registration(self):
        ...
        self.wait.until(EC.presence_of_element_located((By.CLASS_NAME, 'pe-7s-user-female'))).click()
        ...
        state_select = Select(self.wait.until(EC.presence_of_element_located((By.XPATH, "//select[option[contains(text(), 'Select a state')]]"))))
