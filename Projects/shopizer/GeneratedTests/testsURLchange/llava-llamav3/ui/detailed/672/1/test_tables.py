...
class TestShopifyWebpage(unittest.TestCase):
    ...
    def test_verify_ui_reaction(self):
        ...
        first_name_input = self.wait.until(EC.presence_of_element_located((By.XPATH, "//html/body/form/input[@name='first_name']")))
        last_name_input = self.wait.until(EC.presence_of_element_located((By.XPATH, "//html/body/form/input[@name='last_name']")))
        email_input = self.wait.until(EC.presence_of_element_located((By.XPATH, "//html/body/form/input[@name='email']")))
        password_input = self.wait.until(EC.presence_of_element_located((By.XPATH, "//html/body/form/input[@name='password']")))
