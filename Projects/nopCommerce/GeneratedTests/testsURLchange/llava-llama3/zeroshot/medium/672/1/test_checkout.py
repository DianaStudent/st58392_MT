...
class TestEcommerce(unittest.TestCase):
    ...
    def test_orderCompletion(self):
        ...
        search_box = WebDriverWait(self.driver, 20).until(EC.presence_of_element_located((By.XPATH, "//input[@placeholder='Search']"))))
        ...
        WebDriverWait(self.driver, 20).until(EC.presence_of_element_located((By.XPATH, "//a[@class='product-link'][1]//button[1]"))))
        ...
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable(By.XPATH, "//button[@class='cart-former__button__text'][1]")))
        checkout_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable(By.XPATH, "//button[@class='cart-former__button__text'][2]")))
        self.driver.execute_script(f'arguments[0].click();')
        
        # Step 6: Choose "Checkout as Guest".
        guest_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//a[@class='cart-former__item__action__item__quantity'][1]//button[@class='cart-former__item__action__item__quantity__text'][3]")))
        self.driver.execute_script(f'arguments[0].click();')
        ...
        select_shipping = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//label[@class='form-field__control'][1]")))
        self.driver.execute_script(f'arguments[0].setAttribute("value", "#shippingoption_1");')
        
        select_payment_method = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//label[@class='form-field__control'][3]")))
        self.driver.execute_script(f'arguments[0].setAttribute("value", "#paymentmethod_1");')

        # Step 9: Enter credit card details.
        select_credit_card_type = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//label[@class='form-field__control'][4]")))
        self.driver.execute_script(f'arguments[0].setAttribute("value", "CreditCardType: visa");')
        enter_cardholder_name = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//label[@class='form-field__control'][5]")))
        self.driver.execute_script(f'arguments[0].setAttribute("value", "CardholderName: Test User");')
        enter_card_number = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//input[@class='form-control form-field__text'][6]")))
        self.driver.execute_script(f'arguments[0].setAttribute("value", "CardNumber: 4111111111111111");')
        select_expire_month = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//label[@class='form-field__control'][7]")))
        self.driver.execute_script(f'arguments[0].setAttribute("value", "ExpireMonth: 4");')
        select_expire_year = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//label[@class='form-field__control'][8]")))
        self.driver.execute_script(f'arguments[0].setAttribute("value", "ExpireYear: 2027");')

        # Step 10: Confirm the order.
        confirm_button = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//button[@class='cart-former__button__text'][3]")))
        self.driver.execute_script(f'arguments[0].click();')
