...
class AddToCartTest(unittest.TestCase):
    ...
    def test_add_to_cart(self):
        ...
        # Click search button
        try:
            search_button = wait.until(presence_of_element_located((By.CSS_SELECTOR, 'button.button-1.search-box-button')))
            search_button.click()
        except Exception as e:
        ...
        try:
            add_to_cart_button = wait.until(presence_of_element_located((By.CSS_SELECTOR, '.product-box-add-to-cart-button')))
