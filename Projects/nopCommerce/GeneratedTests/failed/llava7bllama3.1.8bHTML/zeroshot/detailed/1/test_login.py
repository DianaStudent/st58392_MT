...
class TestLogin(unittest.TestCase):
    ...
    def test_login(self):
        ...
        login_button = WebDriverWait(self.driver, 20).until(
            EC.element_to_be_clickable((By.CSS_SELECTOR, "#main > .page.login-page > .buttons > button.button-1.login-button"))
        )
        login_button.click()
        ...
        logout_button = WebDriverWait(self.driver, 20).until(
            EC.element_to_be_clickable((By.CSS_SELECTOR, ".admin-header-links > a.administration"))
        )
