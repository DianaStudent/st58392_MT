...
class TestCart(unittest.TestCase):
    ...
    def test_cart(self):
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.LINK_TEXT, "Search"))).click()
        search_input = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.ID, "searchQuery")))
