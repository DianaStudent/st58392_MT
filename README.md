...
| `Scripts/loop/collectLoopResults.py`                   | Report generation for feedback loop results                 | Feedback `.py` test scripts                                                                           | CSV report                     |
| `Scripts/testExecution/runTestsBatch.py`               | Run all generated tests in batches (25/test max)            | Generated `.py` test scripts                                                                          | CSV report                     |
| `Scripts/mutation/collectSuccess.py`                   | Collect passing test cases for mutation testing             | Initial test execution report + generated `.py` test scripts                                          | Copied `.py` test files        |
...
| `Scripts/manualValidation/URLUpdate.py`                | Fix incorrect or inconsistent test URLs                     | Validated `.py` scripts                                                                               | Fixed test scripts             |
