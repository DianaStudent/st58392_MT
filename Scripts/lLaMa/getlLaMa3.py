...
def run_generation(process_name, html_data, prompt_llava, prompt_llama, image_files, output_folder):
    try:
                ...
                for ui_name, html_raw in ui_html_dict.items():
                    ...
                    for prompt_type in prompt_types:
                        ...
                        for res in resolutions:
                            ...
                            executor.submit(run_generation, ui_name, html_data, llava_prompt, llama_prompt, image_files, out_folder)
            ...
            for html_file in html_files:
                ...
                for prompt_type in prompt_types:
                    ...
                    for res in resolutions:
                        ...
                        os.makedirs(out_folder, exist_ok=True)
                        executor.submit(run_generation, process_name, html_data, llava_prompt, llama_prompt, image_files, out_folder)
