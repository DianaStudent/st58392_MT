...
base_dir = rf"C:\Diana\Master\MasterCode\MAX\code\Projects\{project}\Processes"
#base_dir = rf"C:\Diana\Master\MasterCode\code\Projects\{project}\Processes"

html_structure_path = os.path.join(base_dir, "data", "cleanData", "UI_html.json")
prompts_dir = os.path.join(base_dir, "data", "prompts", "gpt4o", "zeroshot")
screenshots_base = os.path.join(base_dir, "data", "screenshots")
output_base = os.path.join(base_dir, "tests", "gpt4o", "ui")
